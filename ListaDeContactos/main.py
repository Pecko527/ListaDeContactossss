...
class Menu:
    ...
    def MenuPrincipal(self):
        ...
        while not salir:
            ...
            if op == 1:
                ...
                contacto = self.__miListaDeContactos.modificarContacto(input("Digite nombre: "),input("Digite apellido: "),input("Digite Nueva direccion: "),input("Digite nuevo correo: "),input("Digite Nuevo telefono: "),input("Digite Nueva Palabra: "))
            elif op == 0:
                salir = True
    ...
    def MenuContacto(self):
        ...
        while not salir:
            ...
            if op == 1:
                contacto=self.__miListaDeContactos.actualizarTelefonos(input("digite el nuevo numero: "), input("añada el contacto que quiere actualizar"))
            elif op == 2:
                contacto=self.__miListaDeContactos.actualizarPalabras(input("digite la nueva palabra: "), input("añada el contacto que quiere actualizar"))
            elif op == 0:
                salir = True
